...
import { Home, Grid3X3, ShoppingBag, MessageCircle, Settings } from "lucide-react";
...
const navItems = [
  ...
  { to: "/admin", label: "التحكم", icon: Settings },
];
          ...
          if (isWhatsApp) {
            return (
              <a
                ...
                className="flex flex-col items-center justify-center gap-0.5 w-16 h-full text-[#25D366]"
              >
